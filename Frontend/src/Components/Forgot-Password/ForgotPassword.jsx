...
const ForgotPasswordPage = () => {
	...
	return (
		<motion.div
			...
			className='max-w-md w-full bg-zinc-300 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'
		>
			<div className='p-8'>
				...
				{!isSubmitted ? (
					<form onSubmit={handleSubmit}>
						<p className='text-zinc-950 mb-6 text-center'>
